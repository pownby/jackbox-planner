...
export default function Controls({ collapseAll, expandAll, collapseAllPacks, expandAllPacks, collapseAllGames, expandAllGames, onChooseRandom }) {
  return (
    <>
      ...
      <button className="randomizer" onClick={onChooseRandom}>Choose For Me!</button>
    </>
  );
}